        ...
        <div className="max-w-6xl mx-auto px-6 h-14 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            {isAuthenticated ? (
              <Link
                to="/inbox"
                className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-md bg-zinc-950 dark:bg-zinc-100 text-white dark:text-zinc-900 text-xs font-medium hover:bg-zinc-800 dark:hover:bg-white transition-colors shadow-xs"
              >
                Vào Hộp Thư
              ...
              <>
                <button
                  ...
                  className="text-sm font-medium text-zinc-600 dark:text-zinc-300 hover:text-zinc-950 dark:hover:text-white transition-colors px-2.5 py-1 cursor-pointer bg-transparent border-0"
                >
                  Đăng nhập
                </button>
                <button
                  type="button"
                  onClick={handleGoogleLogin}
                  className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-md bg-zinc-950 dark:bg-zinc-100 text-white dark:text-zinc-950 text-xs font-medium hover:bg-zinc-800 dark:hover:bg-white transition-colors shadow-xs cursor-pointer"
                >
                  Kết nối Gmail
          ...
          <div className="p-8 rounded-xl bg-zinc-950 text-zinc-100 flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
            ...
            <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
              {isAuthenticated ? (
                ...
                >
                  <span>Mở Ứng Dụng với Google</span>
                  <ChevronRight className="w-3.5 h-3.5" />
                </button>
              )}
            </div>
        ...
        <div className="max-w-6xl mx-auto px-6 py-12">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 pb-8 border-b border-zinc-100 dark:border-zinc-800/80">
            ...
            <div className="flex items-center gap-6 text-zinc-600 dark:text-zinc-400 text-xs">
              ...
              {isAuthenticated ? (
                <Link to="/inbox" className="hover:text-zinc-950 dark:hover:text-zinc-100 transition-colors">Hộp thư</Link>
              ) : (
                <button
                  type="button"
                  onClick={handleGoogleLogin}
